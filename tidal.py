...
def main():
    ...
    if args.urls[0] == 'auth' and len(args.urls) == 1:
        ...
        if len(args.urls) == 2:
            ...
            print('Example usage: python tidal.py id 92265335')
            exit()
        ...
        try:
            ...
            print("Example usage of explore: python tidal.py explore (atmos (albums|tracks) | 360)")
            exit()
        ...
        while True:
            ...
            if args.urls[1] == 'track':
                ...
                print("Example usage of search: python tidal.py search [track/album/video] Darkside Alan Walker")
                exit()
